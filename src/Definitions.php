...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'magic_links'; }
    public static function contractView(): string { return 'vw_magic_links'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'fingerprint', 'subject', 'user_id', 'context', 'expires_at', 'created_at' ]; }
    ...
    public static function piiColumns(): array { return [ 'fingerprint', 'context' ]; }
