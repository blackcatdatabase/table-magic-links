...
namespace BlackCat\Database\Packages\MagicLinks\Repository;

use BlackCat\Core\Database as Database;              // e.g. BlackCat\Core\Database
use BlackCat\Database\Packages\MagicLinks\Definitions;
use BlackCat\Database\Packages\MagicLinks\Criteria;
use BlackCat\Database\Packages\MagicLinks\Dto\MagicLinkDto as Dto;
use BlackCat\Database\Packages\MagicLinks\Mapper\MagicLinkDtoMapper as RowMapper;
...
use BlackCat\Database\Packages\MagicLinks\Repository\MagicLinkRepositoryInterface;
...
class MagicLinkRepository implements MagicLinkRepositoryInterface, RepoContract, KeysetRepoContract
{
use OrderByTools, PkTools, RepositoryHelpers;
     ...
     */
    protected function def(): string { return \BlackCat\Database\Packages\MagicLinks\Definitions::class; }
    ...
    private function doUpsert(array $row, bool $revive): void
    {
        ...
        $updCols = [ 'subject', 'user_id', 'context', 'expires_at' ];
    ...
    public function upsertMany(array $rows): int {
        ...
        if ($helperKeys && class_exists(\BlackCat\Database\Support\BulkUpsertHelper::class)) {
          $bulk = new \BlackCat\Database\Support\BulkUpsertHelper($this->db, \BlackCat\Database\Packages\MagicLinks\Definitions::class);
          $bulk->upsertMany($rows, $helperKeys, [ 'subject', 'user_id', 'context', 'expires_at' ]);
          return count($rows);
        }
    ...
    /** @return array<string,mixed>|\BlackCat\Database\Packages\MagicLinks\Dto\MagicLinkDto|null */
    public function getByFingerprint(string $fingerprint, bool $asDto = false): array|\BlackCat\Database\Packages\MagicLinks\Dto\MagicLinkDto|null {
