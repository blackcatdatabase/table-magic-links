...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_magic_links_expires', 'idx_magic_links_subject', 'idx_magic_links_user' ];
        if ($d->isMysql()) {
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_magic_links_expires', 'idx_magic_links_subject', 'idx_magic_links_user' ],
