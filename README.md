...
| Pkg folder | [packages/magic-links](https://github.com/blackcatacademy/blackcat-database/blob/main/packages/magic-links) | Repo location |
...
graph LR
  ...
  magic_links["magic_links"]:::center
  magic_links -->|FK| users["users"]:::link
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package magic-links -Apply
